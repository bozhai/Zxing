...
public final class CameraManager {
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			Size screeSize = configManager.getScreenResolution();
			if (screeSize == null) {
			...
			if (screeSize.width > screeSize.height) {
				screeSize.exchange();
			}

			int leftOffset = (screeSize.width - width) / 2;
			int topOffset = (screeSize.height - height) / 2;
	...
	public synchronized Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			Size screenSize = configManager.getScreenResolution();
			if (cameraResolution == null || screenSize == null) {
				// Called early, before init even finished
				return null;
			}
			...
			//Add to fix portrait
			rect.left = rect.left * cameraResolution.y / screenSize.width;
			rect.right = rect.right * cameraResolution.y / screenSize.width;
			rect.top = rect.top * cameraResolution.x / screenSize.height;
			rect.bottom = rect.bottom * cameraResolution.x / screenSize.height;
